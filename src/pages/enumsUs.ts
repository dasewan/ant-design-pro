...
export const US_VERIFY_STATUS_ENUM: StatusEnum = {
  10: { text: 'WAITING', status: 'Default' },
  20: { text: 'PROCESSING', status: 'Processing' },
  30: { text: 'UNKNOWN', status: 'Default' },
  40: { text: 'FAIL', status: 'Error' },
...
export const US_NEWS_ENUM: StatusColorEnum = {
...
// 客户当前页面
export const US_INDEX_ACTION_ENUM: StatusEnum = {
...
//授信
export const US_CREDIT_TYPE_ENUM: StatusEnum = {
  1: { text: '提额', status: 'Error' },
  2: { text: '降额', status: 'Success' },
};
//订单状态
export const US_BORROW_STATUS_ENUM: StatusColorEnum = {
...
export const US_BORROW_STATUS_MAP = {
  VERIFY: 10,
  SIGN: 20,
  MACHINE: 30,
  REVIEW: 40,
...
export const US_VERIFY_STATUS_MAP = {
  NOT_YET: 10,
  WAIT: 20,
  OVERVIEW: 30,
  REFUSE: 40,
...
export const US_BORROW_SUB_STATUS_ENUM: StatusEnum = {
...
//管理员操作
export const US_OPERATE_ENUM: StatusColorEnum = {
...
//产品结算方式
export const US_PRODUCT_SETTLEMENT_TYPE: StatusColorEnum = {
  1: { text: '头收', color: '#87d068' },
  2: { text: '只头收服务费', color: '#2db7f5' },
  3: { text: '后收', color: '#f50' },
};
//产品结算方式
export const US_PRODUCT_TYPE: StatusColorEnum = {
...
//状态：启用/禁用
export const US_COMMON_STATUS_INT: StatusEnum = {
  1: { text: '启用', status: 'Success' },
  2: { text: '禁用', status: 'Error' },
};
export const US_COMMON_STATUS_INT_ARRAY: StatusOption[] = [
  {
    label: '启用',
    value: 1,
  },
...
//状态：允许/不允许
export const US_COMMON_STATUS_YUNXU: StatusEnum2 = {
  y: { text: '允许', status: 'Success' },
  n: { text: '不允许', status: 'Error' },
};
export const US_COMMON_STATUS_YUNXU_ARRAY: StatusOption[] = [
  { label: '允许', value: 'y' },
  { label: '不允许', value: 'n' },
];
...
//1还款链接 2：app
export const US_REPAY_WAY: StatusEnum = {
  1: { text: '还款链接', status: '' },
  2: { text: 'app', status: '' },
};
...
export const US_FLOW_TYPE_ARRAY: StatusOption[] = [
  {
    label: '随机',
    value: 1,
  },
...
//产品结算方式
export const US_ASSIGN_TYPE: StatusEnum = {
  1: { text: '按比补齐', status: 'Default' },
  2: { text: '按比分配', status: 'Processing' },
};
export const US_ASSIGN_TYPE_ARRAY: StatusOption[] = [
  {
    label: '按比补齐',
    value: 1,
  },
...
export const US_COLLECTION_FLOW_TYPE: StatusEnum = {
  1: { text: '系统', status: 'Default' },
  2: { text: '管理员', status: 'Error' },
};
export const US_COLLECTION_ASSIGN_LOG_TYPE: StatusColorEnum = {
  1: { text: '机构', color: '#0099FF' },
  2: { text: '小组', color: '#a0c69d' },
  3: { text: '催员', color: '#CC99CC' },
};
export const US_COLLECTION_ASSIGN_LOG_CAT_TYPE: StatusEnum = {
  1: { text: '计划任务', status: 'Default' },
  2: { text: '管理员释放', status: 'Error' },
  3: { text: '管理员转移', status: 'Warning' },
};
export const US_RISK_TAGS_ENUM: StatusEnum = {
  100: { text: '新客', status: '' },
...
export const US_RISK_TAGS_ARRAY: StatusOption[] = [
  {
    label: '新客',
    value: '100',
  },
...
export const US_RISK_TAGS_GROUP_ARRAY: StatusOption[] = [
  {
    label: '借款次数',
    value: 'borrow',
  },
...
export const US_DPDS: StatusOption[] = [
  {
    label: 'DPD0',
    value: '0',
  },
...
export const US_DIMENSIONS: StatusOption[] = [
  {
    label: '逾期率',
    value: 'rate',
  },
...
export const US_PERIODS: StatusOption[] = [
  {
    label: '1 P',
    value: '1',
  },
...
export const US_BORROW_COUNT_GROUP: StatusOption[] = [
  {
    label: '1 T',
    value: '1',
  },
...
export const US_BORROW_AMOUNT_GROUP: StatusOption[] = [
  {
    label: '1000',
    value: '1',
  },
