import { LOAN_LOG_TYPE } from '@/pages/enums';
    ...
    >
      <Descriptions column={{ xxl: 4, xl: 4, lg: 3, md: 3, sm: 2, xs: 1 }} bordered>
        ...
        <Descriptions.Item label={FieldLabels.a_a_a_a_a_d_borrow.b_channel_id}>
          {
            props.channels.find((item) => item.value == oldRecord?.a_a_a_a_a_d_borrow?.b_channel_id)
              ?.label
          }
        </Descriptions.Item>
        ...
        <Descriptions.Item label={FieldLabels.g_type}>
          {LOAN_LOG_TYPE[FieldLabels?.g_type]?.text}
        </Descriptions.Item>
        <Descriptions.Item label={FieldLabels.h_status} span={2}>
          {LOAN_LOG_TYPE[FieldLabels?.h_status]?.text}
        </Descriptions.Item>
        ...
        <Descriptions.Item label={FieldLabels.a_b_index}>{oldRecord?.a_b_index}</Descriptions.Item>
