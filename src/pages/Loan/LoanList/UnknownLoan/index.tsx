...
const TableList: React.FC = () => {
  ...
  const _index = async (
    ...
    // 如果需要转化参数可以在这里进行修改
    // @ts-ignore
    const res = await index({ page: params.current, f_status: 30, ...params });
    // @ts-ignore
      ...
      render: (_, record) => {
        const transfer = (
          <Popconfirm
            title={
              <>
                This transfer result is unknown,Are you sure to transfer
        ...
        const bankTransfer = <a key="edit">置为成功</a>;
