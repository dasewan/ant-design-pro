import {getAdminV1WPBackFills as index} from '@/services/ant-design-pro/WPBackFill';
...
import Chart2 from "@/pages/Statistics/Sms/BackFill/components/Chart2";
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    {
      title: FieldLabels.f_sented_person,
      dataIndex: FieldIndex.f_sented_person,
      search: false,
      width: 80,
    },
    {
      title: FieldLabels.g_success_person,
      dataIndex: FieldIndex.g_success_person,
      search: false,
      width: 80,
    },
    {
      title: FieldLabels.h_success_person_rate,
      dataIndex: FieldIndex.h_success_person_rate,
      search: false,
      width: 80,
    }, {
      title: FieldLabels.i_total_amount,
      dataIndex: FieldIndex.i_total_amount,
      search: false,
      width: 80,
    },
    {
      title: FieldLabels.j_unit_amount,
      dataIndex: FieldIndex.j_unit_amount,
      search: false,
      width: 80,
    },
    {
      title: FieldLabels.k_unit_person_amount,
      dataIndex: FieldIndex.k_unit_person_amount,
      search: false,
      width: 80,
    },
    {
      title: FieldLabels.l_backfill_rate,
      dataIndex: FieldIndex.l_backfill_rate,
      search: false,
      width: 80,
    },
