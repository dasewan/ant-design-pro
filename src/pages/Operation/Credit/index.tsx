  ...
  return (
    ...
    >
      <div>
        ...
        <p>
          <MathFormula
            formula="\Delta S_{\text{penalty}} = -\frac{p \cdot \text{overdueDays}}{1 + q \cdot \text{overdueDays}}"/>
        </p>

        <h3>还款奖励公式</h3>
        <p>
          <MathFormula
            formula="\Delta S_{\text{reward}} = \frac{k}{(1 + a \cdot \text{overdueDays}) \cdot (1 + b \cdot \text{repayCount})}"/>
        </p>
